...
//        }
    ...
    public Map<String, String> refund(Map<String, String> reqData) throws Exception {
        reqData.put("op_user_id", this.config.getMchID());
    ...
    public Map<String, String> getsignkey() throws Exception {
        ...
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
        return WXPayUtil.xmlToMap(respXml);
    }
